...
public class Project2 {
    ...
    public static final Class<? extends Application> APPLICATION_CLASS = App.class; // TODO sem dosaď vlastnú triedu
    public static final CarParkService service = new CarParkService();
    ...
    public static void postStart() {
        ...
        User user = (User) service.createUser("Admin","Adminovy","admin@vsa.sk");
