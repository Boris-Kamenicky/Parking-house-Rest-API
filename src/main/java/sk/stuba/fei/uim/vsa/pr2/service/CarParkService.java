...
public class CarParkService extends AbstractCarParkService {
    ...
    public Object updateCarPark(Object carPark){
        ...
        k.setCarParkFloors(newCp.getCarParkFloors());
    ...
    public Object updateCar(Object car) {
        ...
        k.setVehicleRegistrationPlate(newCp.getVehicleRegistrationPlate());
    ...
    public Object getUser(String email) {
        ...
        if ((User)userQuery.getResultStream().findFirst().orElse(null)==null)
        {
            return new User();
        }
        User user = (User) userQuery.getResultStream().findFirst().orElse(null);
    ...
    public List<Object> getUsers() {
        ...
        em.close();
        return Arrays.asList(users.toArray());  //Collections.singletonList(users)
    }
    ...
    public Object createReservation(Long parkingSpotId, Long cardId) {
        ...
        spot.setReservationsByOne(reservation); //test
        em.getTransaction().commit();
        em.close();
        persist(reservation);
        return reservation;
    ...
    public List<Object> getMyReservations(Long userId) {
        ...
        for (Reservation s : reservations){
            if(Objects.equals(s.getCar().getUser().getId(), userId)){
                list.add(s);
            }
        }
        em.close();
    ...
    public void giveCouponToUser(Long couponId, Long userId) {
        ...
        em.getTransaction().begin();
        List<DiscountCoupon> list = user.getDiscountCoupons();
        list.add(coupon);
        user.setDiscountCoupons(list);
        coupon.setUser(user);
        em.getTransaction().commit();
    }
    ...
    public List<Object> getCoupons(Long userId) {
        ...
        em.close();
        return Arrays.asList(coupons.toArray());
    }
    ...
    public List<ParkingSpot> getParkingSpotsOccupiedNew(Long carParkId, String floorIdentifier) {
        EntityManager em = emf.createEntityManager();
    ...
    public void updateId(Long id, Long newId){
        EntityManager em = emf.createEntityManager();
        CarParkFloor k = em.find(CarParkFloor.class, id);
        em.getTransaction().begin();
        k.setId(newId);
        em.getTransaction().commit();
    }

    public List<ParkingSpot> getParkingSpotsFreeNew(Long carParkId, String floorIdentifier) {
        EntityManager em = emf.createEntityManager();
    ...
    public Map<String, List<ParkingSpot>> getAvailableParkingSpotsNew(String carParkName) {
        EntityManager em = emf.createEntityManager();
        Map<String, List<ParkingSpot>> mapka = new HashMap<String, List<ParkingSpot>>();
        CarPark carpark = (CarPark) getCarPark(carParkName);
        Query q = em.createNativeQuery ("SELECT * from CAR_PARK_FLOOR where CARPARK_ID = '" + carpark.getId() +  "'" , CarParkFloor.class);
        List <CarParkFloor> floors =  q.getResultList();
        for (CarParkFloor floor :  floors) {
            mapka.put(floor.getFloorIdentifier(),getParkingSpotsFreeNew(carpark.getId(),floor.getFloorIdentifier())); //tu si
        }
        em.close();
        return mapka;
    }

    public Map<String, List<ParkingSpot>> getOccupiedParkingSpotsNew(String carParkName) {
        EntityManager em = emf.createEntityManager();
        Map<String, List<ParkingSpot>> mapka = new HashMap<String, List<ParkingSpot>>();
        CarPark carpark = (CarPark) getCarPark(carParkName);
        Query q = em.createNativeQuery ("SELECT * from CAR_PARK_FLOOR where CARPARK_ID = '" + carpark.getId() +  "'" , CarParkFloor.class);
        List <CarParkFloor> floors =  q.getResultList();
        for (CarParkFloor floor :  floors) {
            mapka.put(floor.getFloorIdentifier(),getParkingSpotsOccupiedNew(carpark.getId(),floor.getFloorIdentifier())); //tu si
        }
        em.close();
        return mapka;
    }

    public List<ParkingSpot> getParkingSpotsNew(Long carParkId, String floorIdentifier) {
        EntityManager em = emf.createEntityManager();
    ...
    public Map<String, List<ParkingSpot>> getParkingSpotsNeww(Long carParkId) {
        EntityManager em = emf.createEntityManager();
        Map<String, List<ParkingSpot>> mapka = new HashMap<String, List<ParkingSpot>>();
        ...
        for (CarParkFloor floor :  floors) {
            mapka.put(floor.getFloorIdentifier(),getParkingSpotsNew(carParkId,floor.getFloorIdentifier()));
        }
    ...
    public List<ParkingSpot> getParkingSpotsUltraNew(Long carParkId, String floorIdentifier) {
        EntityManager em = emf.createEntityManager();
    ...
    public List<Car> getCarsList(Long userId) {
        EntityManager em = emf.createEntityManager();
    ...
    public Object getReservation(Long resId) {
        EntityManager em = emf.createEntityManager();
        Reservation p = em.find(Reservation.class, resId);
        em.close();
        return p;
    }
    ...
    public List<Object> getReservationsForFloor(Long parkingSpotId) {
        EntityManager em = emf.createEntityManager();
        ParkingSpot spot = (ParkingSpot) getParkingSpot(parkingSpotId);
    ...
    public List<Object> getReservationsForCar(Long carId) {
        EntityManager em = emf.createEntityManager();
        ParkingSpot spot = (ParkingSpot) getParkingSpot(carId);
    ...
    public List<Object> getCouponsAll() {
        EntityManager em = emf.createEntityManager();
        Query q = em.createNativeQuery("select * from DISCOUNT_COUPON", DiscountCoupon.class);
        List<DiscountCoupon> coupons = q.getResultList();
        em.close();
        return Arrays.asList(coupons.toArray());
    }

    public boolean authencitate(String email,String password){
